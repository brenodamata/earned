...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post metrics_url, params: { metric: { frequency: @metric.frequency, name: @metric.name, unit_of_measure: @metric.unit_of_measure } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { frequency: @metric.frequency, name: @metric.name, unit_of_measure: @metric.unit_of_measure } }
