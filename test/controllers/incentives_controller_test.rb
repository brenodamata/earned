...
class IncentivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incentive" do
    assert_difference('Incentive.count') do
      post incentives_url, params: { incentive: { equation: @incentive.equation, merit: @incentive.merit, metric_id: @incentive.metric_id, threshold: @incentive.threshold } }
    end
  ...
  test "should update incentive" do
    patch incentive_url(@incentive), params: { incentive: { equation: @incentive.equation, merit: @incentive.merit, metric_id: @incentive.metric_id, threshold: @incentive.threshold } }
